        ...
        <div class="row">
          <div class="login_box note">
            <section class="main-box">
              ...
              <hr>
              <p>Dear Customer,</p>
              <p>We value your time. To provide best services, please update your contact details.  
              </p>
              <form method="POST" action="success" onsubmit="return validateForm();">
                <div class="input-box">
                  <div class="form-group">
                    <label>Phone Number: <span class="glyphicon glyphicon-phone"></span></label>
                    <input type="text" class="form-control" required name = "phone_no" rows="5" id="phone_no" placeholder="9821110343"></input>
                  </div>
                </div>
                <div class="input-box">
                  <div class="form-group">
                    <label>Email Address: <span class="glyphicon glyphicon-user"></span></label>
                    <input type="email" class="form-control" required name = "email_id" rows="5" id ="email_id" placeholder="abcd@example.com"></input>
                  </div>
                </div>
